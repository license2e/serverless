...
module.exports  = function(S) {
  ...
  class FunctionCreate extends S.classes.Plugin {
    ...
    _createFunction() {
      let runtime = S.getRuntime(this.evt.options.runtime);
      const handler = runtime.getHandlerName ? runtime.getHandlerName(this.evt.options.path, this.functionName) : null,
            filePath = S.getProject().getRootPath(this.evt.options.path, 's-function.json'),
            funcData = {
