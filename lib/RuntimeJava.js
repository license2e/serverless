...
module.exports = function (S) {
  ...
  class RuntimeNode extends S.classes.Runtime {
    ...
    packageName(func) {
      ...
      return this.packageHandlerPath(pp); //.replace(pathSepRegExp, '.');
    }
    ...
    getHandlerName(path) {
      return this.packageHandlerPath(path)+ '.Handler'; //.replace(pathSepRegExp, '.') + '.Handler';
    }
