...
module.exports = function(S) {
  ...
  class Function extends S.classes.Serializer {
    ...
    fromObject(data) {
      ...
      if (data.buildTool) {
        this.setBuildTool(data.buildTool);
        delete data.buildTool;
      }
    ...
    setBuildTool(buildToolName) {
      if (buildToolName) {
        this.buildTool = buildToolName;
      } else {
        delete this.buildTool;
      }
    }
    ...
    getRuntime() {
      if(!this._cachedRuntime[this.runtime]){
        this._cachedRuntime[this.runtime] = S.getRuntime(this.runtime);
      }
      return this._cachedRuntime[this.runtime];
    }
    ...
    getBuildTool() {
      if (this.getRuntime().getBuildTool) {
        this.setBuildTool(this.getRuntime().getBuildTool());
      }
    }

    templatePrompts() {
      return this.getRuntime().templatePrompts(this);
    }
